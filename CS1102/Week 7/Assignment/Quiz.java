public class Quiz {
    public static void main(String[] args) {
        ...
        "What is a quiz?",
        "a test of knowledge, especially a brief informal test given to students", "42",
        "a duck",
        ...
        "the other side of the mountain", "c");
        question.check();
        question = new MultipleChoiceQuestion("Why is a quiz?",
        "I think, therefore it is.", "Who is to say?",
        "You tell me.",
        "Because learning is fun!", "Because I said so.",
        "d"); question.check();
        question = new MultipleChoiceQuestion("How is a quiz?", "fair to middling",
        "not bad",
        "by a stroke of luck",
        "by accident",
        "Using Java object-oriented programming!", "e");
        question.check();
